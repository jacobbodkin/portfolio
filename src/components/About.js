      ...
      <div className="about">
        <div className="description row align-items-center">
          ...
          <div className="descText col-md-7 col-12">
            ...
            <p>Recently, I've immersed myself in coding developing mobile and web apps. I designed and developed this site from scratch using React and will constantly be a work-in-progress.</p>

            <p>Austin, TX based, feel free to give me a call or shoot me an email. I'm always happy to talk shop or about aany project you are excited about.</p>
          </div>
        </div>
